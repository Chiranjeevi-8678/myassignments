...
public class DuplicateLead {
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_lastName")).sendKeys("ArunChiranjeevi");
		driver.findElement(By.id("createLeadForm_firstNameLocal")).sendKeys("Chiran");
		...
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("arunciranjeevi001@gmail.com");
		...
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("ACJ");
